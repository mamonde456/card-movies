      ...
      <VideoWrap>
          ...
          <VideoContainer>
            ...
            {props?.link === "users" ? (
              ...
              <MovieImg>
                ...
                <NextBtn onClick={() => nextSlide("movies")}>next</NextBtn>
              </MovieImg>
            )}
            ...
            <VideoContents key="VideoBox">
              ...
              {props?.detail?.production_companies && (
                <CompaniesWrapper>
                  {props.detail.production_companies?.map((el: ICompanies) => (
                    <CompaniesBox>
                      {el.logo_path ? (
                        <CompaniesLogo
        ...
        {props.link === "users" && (
          <VideoCommentsWrap key="comments">
            ...
            <VideoComments>
              <CommentsList>
                {props.detail?.comments?.reverse().map((comment: IComments) => (
